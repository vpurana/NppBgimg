...
void Editor::Paint(Surface *surfaceWindow, PRectangle rcArea) {
	...
	PRectangle rcTextArea = GetClientRectangle();
	surfaceWindow->drawlable_struct.surface_height = rcTextArea.bottom;
	surfaceWindow->drawlable_struct.surface_width = rcTextArea.right;
	surfaceWindow->drawlable_struct.line_start_ex = topLine;
